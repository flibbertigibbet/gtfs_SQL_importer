...
CREATE INDEX "gtfs_stops_the_geom_idx" ON "gtfs_stops" using gist (the_geom);
...
-- Create spatial index
CREATE INDEX "gtfs_shape_geoms_the_geom_idx" ON "gtfs_shape_geoms" using gist (the_geom);
